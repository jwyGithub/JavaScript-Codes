<template>
  <div class="goodsinfo" v-if="datas.goods_info">
    ...
    <div class="title">
      <h3>{{ datas.goods_info.goods_name }}</h3>
      <span class="price"
        >{{ datas.goods_info.goods_price }}/年 【全年/12期】</span
      >
    </div>
    <div class="discount">
      <span>促销</span>
    ...
    <div class="introduction">
      <h3>杂志简介</h3>
      <p>
        《HBRC哈佛商业评论中文版》哈佛商学院标志性刊物，传播工商管理领域中最前沿的思想理论。(
        Harvard Business Review，简称 HBR
        )创建于1922年，是哈佛商学院的标志性杂志。建立之初，它的使命就是致力于改进管理实践。发展90年后，HBR已经成为先进管理理念的发源地，致力于给全世界的专业人士提供缜密的管理见解和最好的管理实践，并对他们及其机构产生积极的影响。目前，HBR在全世界有10种语言的11个授权版本,包括在台湾地区发行的繁体字版和2012年7月起在大陆地区出版的简体中文版。
      </p>
      <h3>杂志社简介</h3>
      <p>
    ...
    <van-popup v-model="show" position="bottom" style="height: 80%;">
      ...
      <ul class="add">
        ...
        <li>
          <a href="javascript:;" @click.stop="addCarInfo(CarGoodInfo)"
            >加入购物车</a
          >
        </li>
        <li>
